...
/**
 * 잠금 대상 기능 키. 본 단위가 실제로 쓰는 2개 + 근접 예정 2개만 등재한다.
 * 미확정 혜택(배지 진화·칭호·AI 리포트 등 게이트 보류분)은 넣지 않는다 —
 * 정의가 바뀌면 재작업이므로. **페르소나는 2026-08-12 세트·배치 사용자 확정으로 이
 * 배제 사유가 소멸해 예외 등재했다**(`docs/plans/ai-persona-teaser.md` D4).
 * 확정 없는 항목을 이 선례로 끌어오지 말 것.
 */
